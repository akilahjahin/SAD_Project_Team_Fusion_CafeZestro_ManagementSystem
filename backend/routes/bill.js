...
// API to get Billing Info. in PDF for printing
...
// API to get Billing Info.
router.get('/getBills', auth.authenticateToken, (req, res, next) => {
    var query = "select *from bill order by id DESC";
    if (res.locals.role != 'admin') {
        var query = `select *from bill where createdBy= ${res.locals.email} order by id DESC`
    }
